...
public final class EntitySystemInterface
{
    ...
    /**
     * Executes the given job while obtaining a lock on the internal entity system.
     *
     * @param job
     */
    ...
    /**
     * Executes the given job with the given input while obtaining a lock on the internal entity system.
     *
     * @param job       job to execute
     * @param input     input as declared / needed by the job
